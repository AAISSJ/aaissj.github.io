...
const displaySection = (fellows) => {
  if (
    fellows &&
    Array.isArray(fellows) &&
    fellows.length
  ) {
    return true;
  } else {
...
const Fellow = ({ fellows, loading, googleAnalytics }) => {
  const renderSkeleton = () => {
    let array = [];
    for (let index = 0; index < fellows.length; index++) {
      array.push(
                ...
                <div className="card-body">
                  ...
                  <div className="col-span-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {loading ? renderSkeleton() : renderfellows()}
                    </div>
                  </div>
                </div>
              </div>
